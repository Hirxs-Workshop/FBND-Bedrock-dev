...
const plants = {
  ...
  "fb:fnaf2_wall_middle": {
    value: "wall_tiles_purple",
    sound: "block.lantern.break",
  },
  "fb:fnaf2_stage_purple_bricks": {
    value: "wall",
    sound: "block.lantern.break",
  },
  "fb:fnaf2_stage_wall_tiles": {
...
world.beforeEvents.worldInitialize.subscribe(({ blockComponentRegistry }) => {
  blockComponentRegistry.registerCustomComponent("fbd:advanced_wall_fnaf2", DoubleFlowerwallsBlockComponent);
});
